...
from .stack_rnn_cell import StackRnnCellBase, StackLstmCell
...
class StackRnn(torch.nn.Module):
    ...
    def __init__(self,
        ...
        for layer_index in range(num_layers):
            ...
            layers.append(layer)
        self.rnn_layers = layers # StackRNN的子module

        self.stacks: List[List[Dict[str, Any]]] = []  # StackRNN的stack
        self.push_buffer: List[Optional[Dict[str, Any]]] = [] # StackRNN
