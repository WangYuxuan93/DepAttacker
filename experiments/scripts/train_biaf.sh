...
add_path=none  # add adversarial sample
add_flag=adversary
total_num=0  # 0表示全部
ratio=0.1
...
CUDA_VISIBLE_DEVICES=$gpu OMP_NUM_THREADS=4 PYTHONIOENCODING=utf-8 python -u $main --mode $mode \
 --config /users7/zllei/blackbox-attack/experiments/configs/parsing/biaffine.json \
 --seed $seed \
